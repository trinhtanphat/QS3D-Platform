...
internal static class QuantityScheduleCsvEmptyRowFidelityModuleSmoke
{
    ...
    {
        const string header = "ElementId,ElementName,Code,Dimension,Value,CanonicalUnit\r\n";
        ...
        Equal("ElementId,ElementName,Code,Dimension,Value,CanonicalUnit", lines[0]);
        Equal("00000000-0000-0000-0000-000000000001,'=EMPTY-WALL,,,,", lines[1]);
        Equal("00000000-0000-0000-0000-000000000002,Measured Wall,WALL.AREA,Area,12.5,m2", lines[2]);
