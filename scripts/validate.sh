...
python3 scripts/check-cubicost-tbq-build-up-analysis.py
python3 scripts/check-cubicost-tbq-resource-library.py
python3 scripts/check-cubicost-tbq-trade-analysis.py
python3 scripts/check-cubicost-tbq-bq-library.py
